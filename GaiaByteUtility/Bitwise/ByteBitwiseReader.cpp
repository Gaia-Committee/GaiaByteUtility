...
namespace Gaia::ByteUtility::Bitwise
{
	...
	std::array<bool, 8> ReadBitwiseByte(const Byte& byte)
	{
		...
		bits[0] = accessor.AsBits.Bit7;
		bits[1] = accessor.AsBits.Bit6;
		bits[2] = accessor.AsBits.Bit5;
		bits[3] = accessor.AsBits.Bit4;
		bits[4] = accessor.AsBits.Bit3;
		bits[5] = accessor.AsBits.Bit2;
		bits[6] = accessor.AsBits.Bit1;
		bits[7] = accessor.AsBits.Bit0;
